...
/**
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("===============");
        String publicKey = loadPublicKeyByFile(path);
        System.out.println(publicKey);

        String candidate = "xienan";
        RSAPublicKey rsaPublicKey = loadPublicKeyByStr(publicKey);
        byte[] encodedBytes = encrypt(rsaPublicKey, candidate.getBytes());
        System.out.println("encoded: " + new BASE64Encoder().encode(encodedBytes));

        RSAPrivateKey rsaPrivateKey = loadPrivateKeyByStr(privateKey);
        byte[] decodedBytes = decrypt(rsaPrivateKey, encodedBytes);
