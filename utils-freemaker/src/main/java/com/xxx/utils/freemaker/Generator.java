...
public class Generator {
    private static String url = "jdbc:mysql://10.172.17.191:3306/yyy_test?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true";
    private static String user = "yyyrtest";
    private static  String password = "sxYioke1OOtest00";
    private static  String tableName = "yyy_pay_merchant";
    private static String modelName = "payMerchant";
    private static String packageName = "com.xxx";
